  ...
  return (
    <div className="flex-1 flex items-center justify-center p-10">
      <div className="flex flex-col gap-8 max-lg:items-center">
        ...
        >
          <h1 className="text-4xl max-lg:text-4xl max-lg:leading-10 leading-14 font-semibold">
            Hello, I&apos;m <br />{" "}
          ...
          <p className="text-xl max-lg:text-lg">
            ...
            everyone, <span className={highlight}>front to back</span>. I&apos;m
            looking for <span className={highlight}>a team</span> where I can{" "}
